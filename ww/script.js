...
// Get local Location And Weather Detailss
const getWeatherDetails = () => {
  navigator.geolocation.getCurrentPosition(
    (position) => {
      ...
      // const API_URL_Location = `https://api.openweathermap.org/geo/2.5/reverse?lat=${latitude}&lon=${longitude}&limit=1&appid=${API_KEY}`;
      fetch(API_URL)
        ...
        .then((data) => {
          ...
          if (currentTemp >= 85 && currentTemp < 100) {
            document.getElementById("temp-block").classList.remove("red-text");
            document.getElementById("temp-block").classList.add("yellow-text");
          } else if (currentTemp >= 100) {
            document
              .getElementById("temp-block")
              .classList.remove("yellow-text");
            document.getElementById("temp-block").classList.add("red-text");
          } else {
            document.getElementById("temp-block").classList.remove("red-text");
            document
              .getElementById("temp-block")
          ...
          if (humidity > 64) {
            document.getElementById("humidity-block").classList.add("red-text");
          } else {
            document
              .getElementById("humidity-block")
          ...
          if (windSpeed > 9) {
            document.getElementById("wind-block").classList.add("red-text");
          } else {
            document.getElementById("wind-block").classList.remove("red-text");
          }
